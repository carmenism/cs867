/**
 * flowVis.cpp - A class for representing a flow visualization. Reads in a 
 *  file and renders the flow.  Can also render a legend to explain the 
 *  background. Also provides options for rendering colors.
 *
...
flowVis::flowVis() {
    ...
    blackToWhite->push_back(new Color(0,    0,    0,    1));
    ...
    blackToWhite->push_back(new Color(1,    1,    1,    1));
